...
module.exports = {
  ...
  dev: {
    ...
    assetsPublicPath: '/',
    proxyTable: {
      '/findcart':'http://192.168.0.9:8080/fresh-order/cart',//购物车
      '/order':'http://192.168.0.9:8080/fresh-order',//订单
      '/gc':'http://192.168.0.9:8080/fresh-goods',//商品分类
      '/goods':'http://192.168.0.9:8080/fresh-goods',//商品
      '/store':'http://192.168.0.9:8080/fresh-goods',//商铺
      '/brand':'http://192.168.0.9:8080/fresh-goods',//品牌
      '/comment':'http://192.168.0.9:8080/fresh-goods',//商品评论
      '/goodsStock':'http://192.168.0.9:8080/fresh-goods',//库存
      '/attrGoods':'http://192.168.0.9:8080/fresh-goods',//编辑待审核
      '/goodsStock':'http://192.168.0.9:8080/fresh-goods',//库存
      ...
      '/upload':'http://192.168.0.9:8080/image-base',
       '/voucher':'http://192.168.0.9:8080/fresh-voucher',//代金券
